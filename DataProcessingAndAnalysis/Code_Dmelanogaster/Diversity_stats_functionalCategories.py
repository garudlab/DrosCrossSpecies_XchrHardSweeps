...
def get_Pi(in_file,out_file,out_file2):
    ...
    with open(in_file) as f:
        for line in f:
            ...
            line_out = str(length)+"\t"+str(pi)+"\t"+str(S)+"\t"+str(pi/float(length))+"\t"+str(S/float(length))+"\n"
...
def main():
    ...
    if stat == "pi": 
        get_Pi(in_file,out_file,out_file2) #computes S and Pi
    else:
